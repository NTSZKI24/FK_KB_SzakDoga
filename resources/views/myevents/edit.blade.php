<header>
    ...
    <title>Eseményeim szerkesztése</title>
    ...
    <div class="col-sm-12">
        ...
        <form method="post" action="{{url('/myevents/update',$event->id)}}" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="input-data">
                    <input type="number" name="eventage" required min="0" max="99" value="{{$event->eventage}}">
                    <div class="underline"></div>
            ...
            <div class="form-row">
                <div class="input-data">
                    ...
                    <br>
                    <input type="date" name="eventdate" required value="{{$event->eventdate}}">
                    <div class="underline2"></div>
                </div>
                <div class="input-data">
                    <label for="">Időpont</label>
                    <br>
                    <input type="time" name="eventtime" required value="{{$event->eventtime}}">
                    <div class="underline2"></div>
                </div>
            </div>
            <div class="form-row">
                <div class="input-data">
                    <div class="select">
                        <select name="counties_id" required>
                            <option value="" disabled>Válassz vármegyét</option>
            ...
            <div class="form-row">
                ...
                <div class="input-data">
                    @if($event->image)
                        <p class="current-image-name">Jelenlegi kép: {{ basename($event->image) }}</p>
                    @endif
